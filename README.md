...
## 🚀 V2.2.0 旗艦里程碑：全系統莫蘭迪/Win11美學、無痕托盤與 Auto-Healing 終極雙開

**V2.2.0** 是一個重大的旗艦里程碑：除了完整的 臺北E大 / eCPA / 我的E政府 雙開與自動看課外，本版實現了全平臺 UI 美學升級、無痕系統托盤常駐、Auto-Healing 全自動自我修復與多頻道日誌隔離。

重點更新：

- **Windows 11 經典 Fluent / 莫蘭迪全介面重構**：新增專屬平臺視覺化進度條 (`QProgressBar`)，實時推動閱讀趴數與時數統計。
- **Windows 右下角系統列 (System Tray Icon) 常駐**：點擊 `X` 或最小化時自動無痕縮小至系統列，背景看課持續穩定運行。
- **Auto-Healing 全自動瀏覽器連線靜默修復**：內建 3 次重連上限，遇網路波動或瀏覽器異常自動靜默重啟恢復。
- **多頁籤 Instance-Scoped 獨立日誌頻道隔離**：徹底解決雙開看課時 Log 互相污染問題，實現 100% 精確分流。
- **A+B 作答日誌降噪與 Gemini 429 配額熔斷保護網**：隱藏大段題目，出 429 時自動降級為純本地 2503 題庫秒速答題。
- **臺北E大 SCORM 簡介頁自動跳轉與問卷多重定位**：`find_scorm_link` 自動識別並點擊簡介頁按鈕進教室；問卷支援 `iframe` 穿透提交。
- **臺北E大驗證碼多重影像辨識與重試**：`ddddocr` 原圖無損辨識，空字串時自動 `refreshCaptcha()` 無痛換圖。

---

## 🏛️ 支援平台與全台縣市適用範圍

本軟體完整支援**中央與全台灣 22 縣市政府及所屬機關**之公務人員數位研習：

| 適用縣市 / 機關範圍 | 數位研習平台 | 登入管道 | 支援功能與說明 |
|---|---|---|---|
| **全台灣 22 縣市政府及中央各部會機關**<br>*(包含 基隆市、臺北市、新北市、桃園市、新竹縣/市、苗栗縣、臺中市、彰化縣、南投縣、雲林縣、嘉義縣/市、臺南市、高雄市、屏東縣、宜蘭縣、花蓮縣、臺東縣、澎湖縣、金門縣、連江縣與中央各部會)* | **e等公務員學習網**<br>`https://elearn.hrd.gov.tw` | **人事服務網 (eCPA)**<br>*(ecpa.dgpa.gov.tw)*<br><br>**我的E政府 (eGov)**<br>*(cp.gov.tw)* | 課程自動播放、2503 大題庫作答、AI 補答、問卷自動填寫、自動進度條與視訊計時 |
| **臺北市政府及所屬各級機關學校** | **臺北E大**<br>`https://elearning.taipei` | **臺北E大帳號** | 課程時數計算、簡介頁自動跳轉、自動驗證碼辨識、測驗題庫作答、問卷 `iframe` 提交 |
...
V2.1.8 仍沿用 GitHub Release 作為主要更新來源；Release 內的 `.exe` asset 會作為更新下載檔。
